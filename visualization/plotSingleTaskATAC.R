...
#'
#' @return \code{plotSingleTaskATAC} saves in `outdir` one overview table for each task in three formats (.pdf/.tiff/.png)
...
#' across one or multiple ATAC tasks. 
...
plotSingleTaskATAC <- function(csv_metrics_path, outdir = ".", weight_batch = 0.4){
