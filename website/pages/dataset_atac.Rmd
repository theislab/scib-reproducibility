---
params:
  dataset: "mouse_brain_atac_genes_small"
  fig_dir: false
title: "`r paste('ATAC dataset:', params$dataset)`"
---
...
dataset_meta <- drake::readd("datasets_meta_atac") %>%
        ...
        src_list <- map2_chr(
            ...
            function(.method, .output) {
                src <- c(
                    ...
                    "plots <- plot_embedding_coords(params$dataset, '<<scale>>',",
